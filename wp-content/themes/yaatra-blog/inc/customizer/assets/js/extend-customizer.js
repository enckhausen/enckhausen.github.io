...
(function($) {
	...
	api.bind('pane-contents-reflowed', function() {
		...
		api.section.each(function(section) {
			...
			if (
				'yaatra_blog_section' !== section.params.type ||
		...
		api.panel.each(function(panel) {
			...
			if (
				'yaatra_blog_panel' !== panel.params.type ||
	...
	wp.customize.Panel = wp.customize.Panel.extend({
		attachEvents: function() {
			...
			if (
				'yaatra_blog_panel' !== this.params.type ||
	...
	wp.customize.Section = wp.customize.Section.extend({
		attachEvents: function() {
			...
			if (
				'yaatra_blog_section' !== this.params.type ||
	...
	wp.customize.bind('ready', function () {
        const controlsArray = [
            'yaatra_blog_sidebar_posts_heading_toggle',
            'yaatra_blog_sidebar_pages_heading_toggle',
        ];
